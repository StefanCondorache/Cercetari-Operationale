...
if __name__ == "__main__":
    problema_test = {
        'date_intrare': {
            ...
            'c4': {'node': ('x2', 'x7'), 'value': 12},
            'c5': {'node': ('x2', 'x5'), 'value': 23},
            'c6': {'node': ('x3', 'x5'), 'value': 4},
            'c7': {'node': ('x3', 'x8'), 'value': 24},
            'c8': {'node': ('x3', 'x6'), 'value': 7},
            'c9': {'node': ('x4', 'x6'), 'value': 23},
            'c10': {'node': ('x4', 'x9'), 'value': 28},
            'c11': {'node': ('x5', 'x7'), 'value': 10},
            'c12': {'node': ('x5', 'x8'), 'value': 9},
            'c13': {'node': ('x6', 'x8'), 'value': 12},
            'c14': {'node': ('x6', 'x9'), 'value': 8},
            'c15': {'node': ('x7', 'x10'), 'value': 31},
            'c16': {'node': ('x8', 'x10'), 'value': 23},
